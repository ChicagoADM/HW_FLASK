...
async def get_tasks(request: Request):
    return templates.TemplateResponse('HW_05_template.html', {'request': request, 'tasks': tasks, 'title': 'Tasks'})
...
if __name__ == '__main__':
    uvicorn.run('app_HW_05:app', host='127.0.0.1', port=8000, reload=True)
